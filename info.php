							...
							<div class="questions__items">
								...
								<div class="questions__item">
									...
									<div class="questions__item-hide">
										<div class="questions__item-hide-inner">
											...
											<div class="questions__hide-text">
												...
												<p>Чтобы заказать <strong>подобную услугу в нашей компании,</strong> то вам потребуется: предоставить копию ИНН и паспорта, далее оговариваем виды деятельности вашей будущей компании и совместно выбираем оптимальную систему налогообложения
												...
												<ul>
													<li>Крафт пакеты бумажные с ручками</li>
													<li>Крафт пакеты бумажные без ручек</li>
													<li>Крафт мешки бумажные</li>
												</ul>
											</div>
										</div>
									</div>
